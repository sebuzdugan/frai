...
export const scanRepositoryTool = new DynamicStructuredTool({
    ...
    description: "Scan a codebase for AI indicators using FRAI's static detectors. Provide a relative path when scanning outside the current working directory.",
    schema,
    func: async ({ root }) => {
